...
if (isset($_POST["nyEvent"])) {
    ...
    $eventJSON = $kalenderController->addEvent($newEventObj->title, $newEventObj->start, $newEventObj->end, $_SESSION["brukernavn"], $newEventObj->eventColor, $newEventObj->details);
