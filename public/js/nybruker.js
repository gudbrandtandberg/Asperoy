...
$(document).ready(function(){
	...
	if ($("#profilbildeimg").attr("src") == "") {
	    ...
	    var drit_i_bilde = confirm("Du har ikke valgt et profilbilde.Hvis du ikke ønsker å gjøre dette nå kan du gjøre det på et senere tidspunkt. Klikk avbryt for å legge til et bilde, klikk OK hvis du vil lage bruker");
	    if (drit_i_bilde) {
		//avatar-bilde
